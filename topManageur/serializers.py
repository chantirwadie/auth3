...
class TopManageurSerializer(ModelSerializer):
    user = UserSerializer()
    ...
    def create(self, validated_data):
        ...
        serializer = TopManageurUserIdSerializer(data=validated_data)
...
class TopManageurs(ModelSerializer):
...
class TopManageurUserIdSerializer(ModelSerializer):
